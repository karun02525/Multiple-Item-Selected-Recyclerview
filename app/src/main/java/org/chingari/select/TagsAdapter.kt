...
import kotlinx.android.synthetic.main.adapter_input_item.view.*


class TagsAdapter(var list: List<InputTagModel>) :
    RecyclerView.Adapter<TagsAdapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v = LayoutInflater.from(parent.context)
            .inflate(R.layout.adapter_input_item, parent, false)
        return ViewHolder(v)
    }
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(model: InputTagModel) {
            itemView.apply {
                ...
                tv_level.setOnClickListener {
                    ...
                    val allUnSelected = list.stream().anyMatch { o: InputTagModel -> o.isSelected }
                    for (i in list) {
